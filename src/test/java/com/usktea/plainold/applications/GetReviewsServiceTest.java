...
class GetReviewsServiceTest {
    ...
    void whenProductExists() {
        ...
        given(reviewRepository.findAllByProductId(
                any(ProductId.class), any(Pageable.class)))
                .willReturn(page);

        Page<Review> reviews = getReviewsService.getReviews(productId, pageNumber);
    ...
    void whenProductNotExists() {
        ...
        assertThrows(ProductNotFound.class, () -> getReviewsService.getReviews(productId, pageNumber));
    }
}
